<script>
  export let t;
  export let index;
  import chevronRightSvg from '$lib/images/chevron-right.svg';

  const lang = `home.forWhom.list.${index}`;
</script>
...
<style lang="scss">
  .target {
    ...
    width: 100%;
    padding: 1.2em 1.3em 1.5em 1.5em;
    margin: 1.6em 0 0 0;
  ...
  @media all and (min-width: 1025px) {
    .target {
      ...
      width: 48.95%;
      padding: 2.2em 2.3em 2.5em 2.7em;
      margin: 1.6em 0 0 0;
